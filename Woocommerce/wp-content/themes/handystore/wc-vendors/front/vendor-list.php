...
<li class="single-vendor">
	<div class="inner-vendor-content row">
		...
		<div class="additional-info col-xs-12">
			<span class="total-products"><?php echo esc_html__('Products in total: ', 'dashstore').esc_attr($vendor_products_count); ?></span>
			<a class="btn btn-default rounded link-to-vendor" href="<?php echo esc_url($shop_link); ?>" rel="nofollow"><?php echo esc_html__('Visit Vendor Store', 'dashstore'); ?></a>
		</div>
